...
We suggest you look at `how we build it on GitHub Actions <https://github.com/tudelft3d/val3dity/tree/main/.github/workflows>`_ to get some inspirate (and help).
