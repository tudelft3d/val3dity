...
validate_shell_intersection.o: validate_shell_intersection.cpp
	$(CC) $(CFLAGS) -c $^

main.o: main.cpp
	$(CC) $(CFLAGS) -c $^

main:  input.o validate.o validate_shell.o validate_solid.o validate_2d.o validate_shell_intersection.o main.o
